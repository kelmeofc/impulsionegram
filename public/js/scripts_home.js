...
function buildUtmUrl( checkoutUrl ){
    ...
    }else if( host == 'seguro.impulsionegram.com.br' ){
        if( ig_username != null ){ url.searchParams.set('ig_username', ig_username ); }
        if( customer_name != null ){ url.searchParams.set( 'name', customer_name ); }
        if( customer_phone != null ){ url.searchParams.set( 'phone', customer_phone ); }
        if( customer_email != null ){ url.searchParams.set( 'billing_email', customer_email ); }
        if( customer_document != null ){ url.searchParams.set( 'document', customer_document ); }
