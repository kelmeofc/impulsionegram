...
jQuery("#tt-video-views-free-trial-form").submit(function(event){
    ...
    var already_done = getCookie('free-trial-tiktok-likes');
    ...
    if ( already_done == 'done'){
        ...
        request = jQuery.ajax({
            url: "https://painel.impulsionegram.com.br/api/free-trial/tt-video-views/",
            type: "post",
            data: { 
                username: username,
                email: email,
