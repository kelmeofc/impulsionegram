...
jQuery("#ig-likes-free-trial-form").submit(function(event){
    ...
    if ( already_done == 'done'){
        ...
        Swal.fire({
          ...
          html: "<strong>No ImpulsioneGram você pode comprar curtidas para o seu Instagram de forma fácil, rápida, segura e garantida. Confira:</strong>",
          icon: 'error',
          showCancelButton: true,
          confirmButtonColor: '#fc591e',
          cancelButtonColor: '#a5a5a5',
          confirmButtonText: 'Comprar Curtidas Agora',
          cancelButtonText: 'Cancelar',
          backdrop: `rgba(0,0,123,0.4)`
        }).then((result) => {
          if (result.isConfirmed) {
            window.location.href = 'https://www.impulsionegram.com.br/comprar-curtidas-instagram/?utm_souce=teste-gratis';
          }
        });
        ...
        request = jQuery.ajax({
            url: "https://painel.impulsionegram.com.br/api/free-trial/ig-likes/",
            type: "post",
            data: { 
                username: username,
                email: email,
        ...
        request.done(function (response, textStatus, jqXHR){
            ...
            if( result.status == 'not-found' ){
                ...
                Swal.fire(
                  'Quase lá!',
                  'Enviamos um e-mail com o link para confirmar o envio de suas curtidas! Acesse seu e-mail e clique no botão "Confirmar envio de visualizações".',
                  'success'
                ).then((result) => {
                  if (result.isConfirmed) {
                    ...
                    //window.location.href = 'https://www.impulsionegram.com.br/comprar-curtidas-instagram/?utm_source=teste-gratis&utm_medium=redirect';
                  }
                });
            }
