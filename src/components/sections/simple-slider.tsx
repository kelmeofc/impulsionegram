        ...
        <div className="container">
          <div className="flex items-center justify-between max-w-[550px] mx-auto gap-3">
            ...
            <p className="min-[580px]:w-[190px] max-[400px]:text-center max-[550px]:text-[10px] font-medium">
              Mais de <span className="font-bold">62.356</span> pessoas usam o
              ImpulsioneGram
            </p>
          </div>
          ...
          <Carousel className="mt-9" setApi={setApi}>
            ...
            <CarouselContent className="px-5 gap-6">{children}</CarouselContent>
          </Carousel>
          ...
          <div className="flex items-center justify-center gap-1 mt-6 max-[550px]:mt-5">
            {Array.from({ length: count }).map((i: any, index) => {
              return (
                <span
                  key={index}
                  className="block w-3 h-3 bg-[#F9BF10] opacity-50 rounded-full"
                  style={{
