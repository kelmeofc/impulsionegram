				...
				>
					...
					<div className="relative">
						...
						<input
							type="text"
							value={user}
							className="text-lg font-medium text-[#584566] w-full py-3 px-8 pl-12 rounded-full"
					...
					<label className="text-lg flex items-center gap-3 text-white cursor-pointer">
						...
						<span>
							...
							<Link
								target="_blank"
								className="underline"
								href="https://www.impulsionegram.com.br/termos-de-uso/"
							>
								termos de compra
							</Link>{" "}
							e de{" "}
							<Link
								href="https://www.impulsionegram.com.br/termos-de-responsabilidade/"
								target="_blank"
								className="underline"
							>
								responsabilidade
					...
					{!checked && !(!user) && (
						<span className="text-lg text-[#D21919] font-medium px-14 w-full text-center mx-auto relative">
							...
							>
								<path
									d="M15.8762 0.438769L14.2496 1.8238L0.612793 13.98L3.20393 17.5093L12.9338 8.83584L12.6543 11.4949C10.4465 32.501 24.1824 51.2101 43.2866 53.2181L43.7575 48.7377C26.8536 46.9611 14.7755 30.5099 16.729 11.9232L17.0087 9.26187L24.7224 19.771L27.9907 16.8575L17.1793 2.13173L15.8762 0.438769Z"
									fill="#D21919"
								/>
							</svg>
					...
					<h3 className="text-3xl font-bold text-center text-[#3F2553]">
						Pagamento
					</h3>

					<Link
						href={`https://seguro.impulsionegram.com.br/checkout?aero-add-to-checkout=${productPackage.payment_id}&ig_username=${user}&utm_source=blog&utm_medium=menu&utm_campaign=google-search`}
						className="text-2xl font-bold text-white py-5 bg-[#5A11AF] flex items-center gap-2 rounded-full justify-center"
						style={{
					...
					<Link
						href={`https://app.monetizze.com.br/checkout/${productPackage.card_id}?src=${user}&utm_source=blog&utm_medium=menu&utm_campaign=google-search`}
						className="text-2xl font-bold text-white py-5 bg-[#5A11AF] flex items-center gap-2 rounded-full justify-center"
						style={{
							pointerEvents: checked && user ? "all" : "none",
							opacity: checked && user ? 1 : 0.5,
					...
					<div className="overflow-auto max-h-[171px] p-5 text-white flex flex-col gap-2 bg-[#CBADE4] rounded-sm">
						...
						<p>
							Antes de prosseguir com a contratação de nossos serviços, é
							crucial que você leia e compreenda o seguinte Termo de
							Responsabilidade e Uso Ético do Serviço, elaborado em conformidade
							com o Código de Defesa do Consumidor (Lei nº 8.078/1990), o Marco
							Civil da Internet (Lei nº 12.965/2014) e a Lei Geral de Proteção
							de Dados (Lei nº 13.709/2018). Ao contratar nossos serviços, você
							concorda com os termos aqui estabelecidos.
						</p>
						<p>Termos e Condições</p>
						<p>
							1. Finalidade Lícita: O cliente concorda em utilizar os serviços
							fornecidos por nossa empresa exclusivamente para fins lícitos e
							não comerciais, conforme estabelecido pelo artigo 5º, inciso II da
							Constituição Federal e artigo 37 do Código de Defesa do
							Consumidor.
						</p>
						<p>
							2. Proibição de Fraude: O cliente se compromete a não utilizar os
							serviços para engajar em atividades fraudulentas, enganosas ou
							qualquer outra forma de comportamento inautêntico, em conformidade
							com o artigo 67 do Código de Defesa do Consumidor.
						</p>
						<p>
							3. Conformidade com as Leis: O cliente deve assegurar que o uso
							dos serviços está em conformidade com todas as leis e regulamentos
							aplicáveis, incluindo, mas não se limitando ao Código de Defesa do
							Consumidor e às diretrizes do Conselho Nacional de Autorregulação
							Publicitária (CONAR).
						</p>
						<p>
							4. Proteção de Dados: O cliente concorda que qualquer dado pessoal
							fornecido está em conformidade com a Lei Geral de Proteção de
							Dados (LGPD), e que a empresa pode processar esses dados para fins
							de prestação de serviços.
						</p>
						<p>
							5. Isenção de Responsabilidade: A empresa não será responsável por
							qualquer uso indevido dos serviços que resulte em ações legais,
							perdas ou danos. O cliente assume total responsabilidade pelo uso
							dos serviços contratados, conforme artigo 14 do Marco Civil da
							Internet.
						</p>
						<p>
							6. Indenização: O cliente concorda em indenizar e isentar a
							empresa de qualquer responsabilidade decorrente do uso indevido
							dos serviços, incluindo qualquer violação deste Termo de
							Responsabilidade, em conformidade com o artigo 927 do Código
							Civil.
						</p>
						<p>
							Ao clicar em &quot;Aceito&quot;, você confirma que leu, entendeu e
							concorda com os termos e condições acima descritos, fundamentados
							nas leis aplicáveis. O não cumprimento destes termos pode resultar
							na rescisão imediata dos serviços e em ações legais.
						</p>
						<p>
							Este Termo de Responsabilidade é uma medida proativa para
							assegurar que nossos serviços sejam utilizados de forma ética e
							legal. Agradecemos por sua compreensão e cooperação.
						</p>
						<p>
							Caso você tenha alguma dúvida ou necessite de esclarecimentos
							adicionais, por favor, entre em contato conosco.
						</p>
						<p>
							Este termo foi elaborado para proteger ambas as partes e garantir
							um uso ético e responsável dos nossos serviços. Certifique-se de
							ler e entender completamente antes de prosseguir.
						</p>
					</div>
				</DialogContent>
			</Dialog>
