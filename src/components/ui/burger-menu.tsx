            ...
            >
                ...
                >
                    <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M2 2L14.7279 14.7279" stroke="#1A002D" stroke-width="3" stroke-linecap="round" />
                        <path d="M14.728 2L2.00011 14.7279" stroke="#1A002D" stroke-width="3" stroke-linecap="round" />
                    </svg>
                </button>
                <ul>
                    {menu.map((li, index) => {
