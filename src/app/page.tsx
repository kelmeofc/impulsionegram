...
export default function Home() {
  ...
  const advantages = [{
    icon: (
      <svg width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M4.49713 1.44971H17.4915L20.7401 6.86404L11.5358 17.1513C11.4652 17.2233 11.3809 17.2805 11.288 17.3196C11.195 17.3587 11.0952 17.3788 10.9943 17.3788C10.8935 17.3788 10.7937 17.3587 10.7007 17.3196C10.6077 17.2805 10.5235 17.2233 10.4529 17.1513L1.24854 6.86404L4.49713 1.44971Z" stroke="#1A002D" strokeWidth="2.16573" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M8.82857 9.02962L6.66284 6.64732L7.31256 5.56445" stroke="#1A002D" strokeWidth="2.16573" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    ...
    icon: (
      <svg width="19" height="20" viewBox="0 0 19 20" fill="none" xmlns="http://www.w3.org/2000/svg">
        <path d="M1.06543 18.4457L2.58758 14.9401C1.42305 13.287 0.901837 11.2658 1.12174 9.25568C1.34165 7.24558 2.28757 5.38483 3.78197 4.02262C5.27638 2.66041 7.21654 1.8904 9.23836 1.85709C11.2602 1.82377 13.2247 2.52944 14.7631 3.84167C16.3016 5.1539 17.3083 6.98248 17.5943 8.98424C17.8803 10.986 17.426 13.0233 16.3166 14.7139C15.2071 16.4045 13.5189 17.6321 11.5686 18.1663C9.6184 18.7005 7.54023 18.5046 5.72414 17.6154L1.06543 18.4457Z" stroke="#1A002D" strokeWidth="1.84503" strokeLinecap="round" strokeLinejoin="round" />
        <path d="M6.60059 8.29784C6.60059 8.42017 6.64918 8.53749 6.73569 8.624C6.82219 8.7105 6.93951 8.7591 7.06184 8.7591C7.18418 8.7591 7.3015 8.7105 7.388 8.624C7.47451 8.53749 7.5231 8.42017 7.5231 8.29784V7.37532C7.5231 7.25299 7.47451 7.13566 7.388 7.04916C7.3015 6.96266 7.18418 6.91406 7.06184 6.91406C6.93951 6.91406 6.82219 6.96266 6.73569 7.04916C6.64918 7.13566 6.60059 7.25299 6.60059 7.37532V8.29784ZM6.60059 8.29784C6.60059 9.52117 7.08655 10.6944 7.95158 11.5594C8.81661 12.4245 9.98984 12.9104 11.2132 12.9104M11.2132 12.9104H12.1357C12.258 12.9104 12.3753 12.8618 12.4618 12.7753C12.5483 12.6888 12.5969 12.5715 12.5969 12.4492C12.5969 12.3268 12.5483 12.2095 12.4618 12.123C12.3753 12.0365 12.258 11.9879 12.1357 11.9879H11.2132C11.0908 11.9879 10.9735 12.0365 10.887 12.123C10.8005 12.2095 10.7519 12.3268 10.7519 12.4492C10.7519 12.5715 10.8005 12.6888 10.887 12.7753C10.9735 12.8618 11.0908 12.9104 11.2132 12.9104Z" stroke="#1A002D" strokeWidth="1.84503" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    ),
    text: 'Suporte humano'
  }, {
  ...
  const informativeBlogTopicsItems: ITopic[] = [{
    ...
    content: (
      <>
        <p>Com o aumento das opções para comprar seguidores no Instagram, é crucial estar informado sobre os desafios e garantir que sua compra seja segura.</p>
        <p>Tomar medidas cautelosas e considerar pontos essenciais é fundamental para uma compra segura e para evitar arrependimentos ao impulsionar o crescimento do seu perfil.</p>
      </>
    ),
    banner: {
    ...
    sub_topics: [{
      ...
      content: (
        <>
          <p>Não se deixe enganar: para ser confirmada, a operação de compra de seguidores no Instagram não precisa da sua senha.</p>
          <p>A senha da sua conta é uma informação pessoal e intransferível e serve apenas para que você possa fazer o login e começar a usar o Instagram.</p>
          <p>Ao divulgar a senha do seu perfil a terceiros, você corre o risco de ter a sua conta invadida e utilizada para outras finalidades, podendo ser prejudicado por pessoas mal intencionadas.</p>
          <p>O ImpulsioneGram nunca irá pedir a sua senha, protegendo a privacidade do seu perfil e respeitando o seu espaço.</p>
        </>
      ),
    }, {
      id: 'como-garantir-a-seguranca-2',
      ...
      content: (
        <>
          <p>Busque por feedbacks e experiências compartilhadas por outros usuários para ter uma visão mais clara sobre a reputação e confiabilidade do site que estiver comprando seguidores.</p>
          <p>Leia atentamente os depoimentos e leve em consideração tanto as avaliações positivas quanto as negativas.</p>
        </>
      ),
    }, {
      id: 'como-garantir-a-seguranca-3',
      ...
      content: (
        <>
          <p>Muitas plataformas no mercado oferecem seguidores “robôs”, ou seja, que não passam credibilidade por não se tratar de um perfil real.</p>
          <p>Além de causar má impressão aos seguidores, um robô pode ser identificado pelo algoritmo. do Instagram e a sua conta corre o risco de ser bloqueada ou mesmo suspensa da plataforma.</p>
          <p>Uma empresa idônea só vai disponibilizar seguidores reais em seus pacotes, garantindo a confiabilidade da operação.</p>
          <p>Todos os seguidores dos pacotes do ImpulsioneGram vêm de uma plataforma de troca de engajamento, onde usuários reais recebem recompensas por interagirem com os perfis de nossos clientes, o que garante a confiabilidade da sua entrega.</p>
        </>
      ),
    }, {
      id: 'como-garantir-a-seguranca-4',
      ...
      content: (
        <>
          <p>É comum encontrarmos perfis com nomes de usuário em outros idiomas, alguns até difíceis de identificar.</p>
          <p>Da mesma forma que seguidores robôs causam uma má impressão, perfis de outras nacionalidades podem causar estranheza dos seguidores e chamar a atenção do algoritmo, que pode prejudicar a entrega do seu conteúdo e as Impressões..</p>
          <p>Nós do ImpulsioneGram oferecemos apenas perfis brasileiros em nossos pacotes de seguidores, para te deixar tranquilo em todas as etapas do processo.</p>
        </>
      ),
    }]
  }, {
    ...
    content: (
      <>
        <p>Existem várias opções de sites onde você pode comprar seguidores para o seu perfil do Instagram.</p>
        <p>Quatro fatores são essenciais para que você tenha uma compra bem sucedida desse tipo de serviço: o preço,a qualidade dos pacotes oferecidos, um suporte eficiente e uma plataforma para acompanhamento do crescimento da sua conta.</p>
        <p>Para decidir pela melhor ferramenta de compra de seguidores, você precisa considerar esses quatro fatores e buscar o melhor custo-benefício.</p>
        <p>É importante escolher uma plataforma de compra de seguidores confiável que respeite sua privacidade e ofereça opções adequadas às suas necessidades.</p>
        <p>Além disso, ter uma variedade de métodos de pagamento disponíveis é fundamental para que você possa escolher a que mais combina com o seu momento.</p>
        <p>Além disso, é fundamental que a plataforma escolhida ofereça diversas formas de pagamento, para que você possa escolher a que mais combina com o seu momento.</p>
        <p>Outro ponto importante: a confiabilidade da compra de seguidores também depende da autenticidade dos perfis e da sua origem.</p>
        <p>Perfis reais e brasileiros são essenciais para manter sua credibilidade e o ImpulsioneGram se destaca por isso: por entregar seguidores 100% reais e brasileiros imediatamente, garantindo uma experiência de compra confiável e resultados rápidos.</p>
        <p>Por fim, ao confirmar sua compra, você receberá seus seguidores contratados e começará a ver os resultados desejados em um curto período de tempo.</p>
        <p>Isso amplia sua confiança na compra e proporciona uma excelente experiência.</p>
        <p>Sendo assim, você terá mais tempo para conseguir criar conteúdos no close friends, feed, stories, reels e conseguir postar eles nas melhores horas do dia! Apenas deixe que o ImpulsioneGram faça o restante do trabalho pesado!</p>
      </>
    ),
    banner: {
    ...
    content: (
      <>
        <p>Em resumo, para evitar ter prejuízos financeiros ou ter um resultado diferente do esperado com a compra dos seguidores para o seu Instagram, você precisa prestar atenção em alguns fatores, como:</p>
        <ul>
          <li>a qualidade dos seguidores comprados: o seu perfil será muito bem visto caso contenha um grande número de seguidores que sejam reais e brasileiros.</li>
          <li>o suporte e atendimento ao cliente: ser atendido por um ser humano, 7 dias por semana, melhora a sua experiência de compra e aumenta a sua confiança em relação à plataforma.</li>
          <li>o preço do pacote: considere os sites que oferecem um preço justo pela qualidade dos seguidores oferecidos e serviços bônus, além de diversas opções de pagamento.</li>
          <li>um painel ou área do cliente, onde você possa visualizar todos os serviços contratados de maneira rápida e instantânea e enviar outros serviços que adquirir futuramente.</li>
          <li>os depoimentos de quem já contratou os serviços da plataforma contando suas experiências de compra.</li>
          <li>a entrega dos seguidores contratados: que deve ser imediata para que você já possa visualizar os benefícios do seu pacote contratado.</li>
          <li>a segurança da plataforma, confirmada através de criptografia.</li>
        </ul>
        <p>O ImpulsioneGram atende a todos esses requisitos e se destaca no mercado por estar há quase 10 anos no mercado, com mais de 46 mil clientes ativos e satisfeitos com os pacotes contratados.</p>
    ...
    sub_topics: [{
      ...
      content: (
        <>
          <p>Comece agora mesmo a comprar seguidores para o seu perfil no Instagram de maneira 100% segura e confiável.</p>
          <p>O ImpulsioneGram oferece pacotes personalizados de seguidores reais e brasileiros, para que você tenha, finalmente, os resultados desejados, como monetizar. sua conta.</p>
          <p>Sem pedir sua senha, com entrega imediata e um suporte humano profissional à sua disposição para te ajudar no que for preciso.</p>
          <p>Além disso, a evolução do seu perfil pode ser acompanhada em tempo real no dashboard exclusivo ao qual você terá acesso assim que confirmar o seu pedido.</p>
          <p>Escolha o pacote que melhor atende às suas necessidades e receba os seus seguidores em questão de minutos.</p>
          <p>Ainda em dúvidas? Faça um teste grátis com 25 seguidores! É muito fácil, basta acessar o link: comprar seguidores teste grátis.</p>
          <p>Mais do que isso, vai ser possível confiar que a compra desses seguidores fará uma grande diferença e que vão impulsionar a sua conta dentro do Instagram.</p>
          <p>Escolha hoje mesmo o melhor pacote de acordo com as suas necessidades!</p>
        </>
      )
    }]
  }];
        ...
        {`
          {
              ...
              "@type": "Product", 
              "name": "Comprar seguidores no Instagram",
              "image": "",
              ...
              "review": {
                "@type": "Review",
                "name": "Meu Instagram tá bombando graças à ImpulsioneGram",
                "reviewBody": ""Antes era muito difícil conseguir seguidores e parcerias, mas desde o dia que comecei a usar o ImpulsioneGram meu Instagram mudou muito e ganhou mais visibilidade."",
                "reviewRating": {
                  "@type": "Rating",
                  "ratingValue": "5",
                  "bestRating": "5",
                ...
                "author": {"@type": "Person", "name": "Thainá Montenegro"},
                "publisher": {"@type": "Organization", "name": "Instagram"}
              }
            }
          `}
      </Script>
