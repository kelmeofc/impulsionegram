...
$(document).ready(function() {
    ...
    $(".btn-checkout.is-package").on('click', function(event) {
        ...
        $('#payment-method-pix').attr('href', monetizze_checkout_link).attr('data-link-checkout', monetizze_checkout_link);
        $('#payment-method-credit-card').attr('href', monetizze_checkout_link).attr('data-link-checkout', monetizze_checkout_link);
        $('#payment-method-billet').attr('href', monetizze_checkout_link).attr('data-link-checkout', monetizze_checkout_link);
