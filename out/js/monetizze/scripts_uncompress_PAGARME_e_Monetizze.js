...
$(document).ready(function() {
    ...
    $('.btn-checkout').each(function(index, element) {
        if( $(this).hasAttr('data-monthly-daily-link-woo') ) { $(this).attr("data-monthly-daily-link-woo", buildUtmUrl($(this).attr("data-monthly-daily-link-woo")) ); }
        if( $(this).hasAttr('data-monthly-instant-link-woo') ) { $(this).attr("data-monthly-instant-link-woo", buildUtmUrl($(this).attr("data-monthly-instant-link-woo")) ); }
        if( $(this).hasAttr('data-yearly-daily-link-woo') ) { $(this).attr("data-yearly-daily-link-woo", buildUtmUrl($(this).attr("data-yearly-daily-link-woo")) ); }
        if( $(this).hasAttr('data-yearly-instant-link-woo') ) { $(this).attr("data-yearly-instant-link-woo", buildUtmUrl($(this).attr("data-yearly-instant-link-woo")) ); }
        if( $(this).hasAttr('data-monthly-daily-link-monetizze') ) { $(this).attr("data-monthly-daily-link-monetizze", buildUtmUrl($(this).attr("data-monthly-daily-link-monetizze")) ); }
        if( $(this).hasAttr('data-monthly-instant-link-monetizze') ) { $(this).attr("data-monthly-instant-link-monetizze", buildUtmUrl($(this).attr("data-monthly-instant-link-monetizze")) ); }
        if( $(this).hasAttr('data-yearly-daily-link-monetizze') ) { $(this).attr("data-yearly-daily-link-monetizze", buildUtmUrl($(this).attr("data-yearly-daily-link-monetizze")) ); }
        if( $(this).hasAttr('data-yearly-instant-link-monetizze') ) { $(this).attr("data-yearly-instant-link-monetizze", buildUtmUrl($(this).attr("data-yearly-instant-link-monetizze")) ); }
        if( $(this).hasAttr('data-link-woo') ) { $(this).attr("data-link-woo", buildUtmUrl($(this).attr("data-link-woo")) ); }
        if( $(this).hasAttr('data-link-monetizze') ) { $(this).attr("data-link-monetizze", buildUtmUrl($(this).attr("data-link-monetizze")) ); }

        // pix monetizze
        //if( $(this).hasAttr('data-link-woo') ) { $(this).attr("data-link-woo", buildUtmUrl($(this).attr("data-link-monetizze")) ); }
        //if( $(this).hasAttr('data-link-monetizze') ) { $(this).attr("data-link-monetizze", buildUtmUrl($(this).attr("data-link-monetizze")) ); }
    });
