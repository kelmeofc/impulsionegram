...
function update_checkout_links_username( ig_username ){
    ...
    btn_pix.setAttribute( 'href', 'https://painel.impulsionegram.com.br/go-checkout/woo/?r=' + encodeURIComponent( userUrlParam( btn_pix.getAttribute('data-link-checkout'), username_field, ig_username ) ) );
    btn_card.setAttribute( 'href', 'https://painel.impulsionegram.com.br/go-checkout/?r=' + btoa( userUrlParam( btn_card.getAttribute('data-link-checkout'), 'src', ig_username ) ) );
    btn_billet.setAttribute( 'href', 'https://painel.impulsionegram.com.br/go-checkout/woo/?r=' + encodeURIComponent( userUrlParam( btn_billet.getAttribute('data-link-checkout'), username_field, ig_username) ) );
...
/* PLANS */
    ...
    document.querySelectorAll('.daily-btn-link, .instant-btn-link').forEach( el => el.addEventListener('click', event => {
        ...
        document.getElementById('payment-method-credit-card').setAttribute( 'href', 'https://painel.impulsionegram.com.br/go-checkout/?r=' + btoa(monetizze_checkout_link) );
...
/* PACKAGES */
    ...
    document.querySelectorAll('.btn-checkout.is-package').forEach( el => el.addEventListener('click', event => {
        ...
        document.getElementById('payment-method-pix').setAttribute( 'href', 'https://painel.impulsionegram.com.br/go-checkout/woo/?r=' + woo_checkout_link );
        document.getElementById('payment-method-credit-card').setAttribute( 'href', 'https://painel.impulsionegram.com.br/go-checkout/?r=' + btoa(monetizze_checkout_link) );
        document.getElementById('payment-method-billet').setAttribute( 'href', 'https://painel.impulsionegram.com.br/go-checkout/woo/?r=' + woo_checkout_link );
